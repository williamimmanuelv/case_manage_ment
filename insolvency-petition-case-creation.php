...
<div class="d-flex align-items-center">
    <a href="insolvency-petition-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Insolvency Petition Case Creation</h5>
            </div>
            <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm btn-primary"><i class="ti ti-upload me-1"></i> Upload</button>
            </div>
        </div>
    </div>
</div>
