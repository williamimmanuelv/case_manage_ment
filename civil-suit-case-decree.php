    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Civil Suit Decree Case Details</h5>
        </div>
        <div class="card-body">
          ...
          <ul class="nav nav-tabs nav-justified nav-bordered nav-bordered-success mb-3" id="caseTabs" role="tablist">
            ...
            <!-- <li class="nav-item" role="tab">
              <a class="nav-link d-flex align-items-center"
                href="civil-suit-case-decree-case-creation.php">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Civil Suit Decree</td>
                      <td> CUS 1002</td>
                      <td><a href="civil-suit-case-decree-list.php" class="badge badge-outline-info me-2">
                          LN 1234/57
                        </a> </td>
                      <td> Car Loan</td>
                      <td> Ram</td>
