...
<div class="d-flex align-items-center">
    <a href="sarfaesi-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Case Creation</h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-4">
                                        <label for="cnr" class="form-label">Allotment No</label>
                                        <select class="form-control" data-choices name="choices-single-default"
                                            id="choices-single-default">
                                            <option value="">Select Allotment No</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="sub-case" value="Sarfaesi-Case">
                                                <option value="">Select</option>
                                                <option value="Section-13-1">Section 13 (2)</option>
                                                <option value="Section-13-2">Section 13 (4)</option>
                        ...
                        <div class="card card-case">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs mb-3" id="caseTabs" role="tablist">
                                    <li class="nav-item">
                                        <a href="#Product" data-bs-toggle="tab" class="nav-link active"
                                            role="tab">Product Details</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#home" data-bs-toggle="tab" class="nav-link" role="tab"> Case
                                            Creation</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="#media" data-bs-toggle="tab" class="nav-link"
                                            role="tab">MED/LOK/CON</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="caseTabsContent">
                                    ...
                                    <div class="tab-pane fade" id="home" role="tabpanel">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <label for="example-select" class="form-label">Case Nature <span
                                                        style="color:red;">*</span></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox Section-13-1 d-none">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Santioned date" />
                                                </div>
                                            </div>

                                            <div class="col-md-6 col-lg-4 casebox Section-13-1 d-none">
                                                <div class="mb-3">
                                                    <label for="input-label" class="form-label">Nature of
                                                        facility</label>
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox Section-13-1 d-none">
                                                <div class="mb-3">
                                                    <label for="input-label" class="form-label">Authorized officer
                                                        name</label>
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox Section-13-2 d-none">
                                                <div class="mb-3">
                                                    <label for="input-label" class="form-label">13(2) Notice
                                                        date</label>
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox Section-13-2 d-none">
                                                <div class="mb-3">
                                                    <label for="input-label" class="form-label">Possession notice under
                                                        Rule 8 (1)</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Possession notice under Rule" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-4 casebox Section-13-2 d-none">
                                                <div class="mb-3">
                                                    <label for="input-label" class="form-label">Paper publication(within
                                                        7 days)</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Paper publication" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-4 casebox Section-13-2 d-none">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox Section-13-2 d-none">
                                                <div class="mb-3">
                                                    <label for="input-label" class="form-label">Sales notice under Rule
                                                        8(6)</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Sales notice under Rule " />
                                                </div>
                                            </div>
                                ...
                                <ul class="nav nav-tabs step-nav" id="sarfaesiTabs" role="tablist">
                                    <li class="nav-item">
                                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#recall">
                                            ...
                                            <span class="step-label">Loan Recall</span>
                                        </button>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#physical">
                                            <span class="step-circle">06</span>
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#auction">
                                            <span class="step-circle">07</span>
                                    ...
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#adjustment">
                                            <span class="step-circle">08</span>
                                            <span class="step-label">Sale Adjustment</span>
                                        </button>
                                    </li>
                                </ul>
                                        ...
                                        <div class="row g-3 mt-2">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <textarea class="form-control" rows="1"
                                                    placeholder="Enter Recall Reason"></textarea>
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <div class="tab-pane fade" id="demand">
                                        ...
                                        <div class="row g-3 mt-2">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <textarea class="form-control" rows="1"
                                                    placeholder="Secured Asset Details"></textarea>
                                            </div>
                                            <div class="col-md-4">
