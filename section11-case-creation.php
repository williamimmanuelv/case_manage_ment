...
<div class="d-flex align-items-center">
    <a href="section11-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Section 11 of Arbitration Act Case Creation</h5>
            </div>
            <div class="card-body">
                            ...
                            <div class="tab-content" id="caseTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <label for="cnr" class="form-label">Institution Name <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" id="Fresh"
