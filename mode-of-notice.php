  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title">Mode Of Digital Notice Report</h5>
        <div>
...
<div class="offcanvas custom-offcanvas offcanvas-end " tabindex="-1" id="editProduct" data-bs-backdrop="static"
  ...
  <div class="offcanvas-header border-bottom">
    <h5 class="fw-semibold">Edit Mode Of Digital Notice</h5>
    <button type="button"
  ...
  <div class="offcanvas-body">
    <form>
      ...
      <div class="mb-3">
        <label class="form-label">Mode Of Digital Notice Name</label>
        <input type="text" class="form-control" placeholder="Mode Of Digital Notice" autocomplete="off">
      </div>
...
<div class="offcanvas custom-offcanvas offcanvas-end " tabindex="-1" id="addProduct" data-bs-backdrop="static"
  data-bs-keyboard="false">
  <div class="offcanvas-header border-bottom">
    <h5 class="fw-semibold">Add Mode Of Digital Notice</h5>
    <button type="button"
      class="btn-close custom-btn-close border p-1 me-0 d-flex align-items-center justify-content-center rounded-circle"
      data-bs-dismiss="offcanvas" aria-label="Close">
      <i class="ti ti-x"></i>
