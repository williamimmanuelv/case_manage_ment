...
<div class="d-flex align-items-center">
  <a href="anticipartory-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
...
<div class="card ">
  <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="custom-table green-table case-table">
              <tr>
                ...
                <td>SubCase Type</td>
                <td class="empty-cell">Cr- Bail/Anticipartory bail</td>
              </tr>
              <tr>
                <td>Filing Date</td>
    ...
    <div class="case-wrapper-fuchsia mb-4">
      <div class="case-header">
        FIR Details
      </div>
      ...
      <div class="card mb-0" style="border-radius: 8px;">
        <div class="card-body">
          <div class="table-responsive">
            <table class="custom-table fuchsia-table case-table">
              <thead>
                <tr>
                  <th>S.NO</th>
                  ...
                  <th>No of accused</th>
                  <th>FIR Date</th>
                  <th>FIR Number/CSR Number</th>
                  <th>Brief of the case(max)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="empty">1</td>
                  <td class="empty">Nungambakkam Police Station</td>
                  <td class="empty">Offense Under Sec001</td>
                  <td class="empty">2</td>
                  <td class="empty">17-02-2026</td>
                  <td class="empty">FIR001</td>
                  <td class="empty">Brief of the Case Details</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="custom-table forest-green-table case-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="empty">14-02-2026</td>
                  <td class="empty"><a href="#" style="color:var(--theme-color);text-decoration:underline;">Link</a>
                  </td>
                </tr>
              </tbody>
            </table>
