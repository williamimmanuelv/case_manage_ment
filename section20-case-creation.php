...
<div class="d-flex align-items-center">
    <a href="section20-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Sec 20 of DRT Case Creation</h5>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <label for="cnr" class="form-label">Case Nature <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" id="Fresh" value="Appeal" />
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <label for="cnr" class="form-label"> CNR NO<span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" id="Fresh" value="CNR NO" />
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <label for="cnr" class="form-label">Case No <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" id="Fresh" value="Case No" />
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <label for="cnr" class="form-label">Court Name <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" id="Fresh" value="Court Name" />
                                        </div>
                                        <div class="col-md-4">
