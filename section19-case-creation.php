...
<div class="d-flex align-items-center">
    <a href="section19-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Section 19 of DRT Case Creation</h5>
