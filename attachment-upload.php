...
<div class="card border-0 rounded-0">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title">Attachment Upload</h5>
    ...
    <div class="card-body">
        <div id="filterSection" class="d-none">
            <div class="row g-4 ">
                ...
                <!-- NOTICE TYPE -->
                <div class="col-md-6 col-lg-4" id="noticeTypeWrapper">
                ...
                <!-- CASE TYPE -->
                <div class="col-md-6 col-lg-4" id="caseTypeWrapper">
                ...
                <!-- Sub Case -->
                <div class="col-md-6 col-lg-4" id="subCaseWrapper">
                    <div>
                ...
                <div class="col-md-6 col-lg-4" style="display: flex; align-items: end;">
                    <div>
        ...
        <div class="table-responsive mt-3" style="height: 300px; border: 1px solid rgb(225, 232, 240);">
            <table class="table table-nowrap table-bordered" id="leads_reports">
        ...
        <div class="row g-4 mt-3">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <select class="form-select">
                    <option>Select Attachment Name</option>
                    <option value="Affidavit">Affidavit</option>
                    <option value="Petition Copy">Petition Copy</option>
                </select>
            </div>
            <div class="col-md-6 col-lg-4">
