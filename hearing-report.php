  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title">Hearing Report</h5>
        <div class="menu">
          ...
          <a href="#" class="link" data-bs-toggle="collapse" data-bs-target="#postalBulkAccordion" aria-expanded="false"
      ...
      <div class="collapse" id="postalBulkAccordion">
        ...
        <div class="container" style="padding: 20px 20px 0px 20px;">
          ...
          <div class="row align-items-center">
            ...
            <div class="row d-flex flex-column justify-content-around col-12 col-lg-4 mb-3col-md-6 col-lg-4">
              <div class="mb-2">
          ...
          <table class="table table-nowrap datatable table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>25-03-2026</td>
                <td>Scheduled</td>
                <td>Notice served successfully</td>
              </tr>
            </tbody>
          </table>
        </div>
