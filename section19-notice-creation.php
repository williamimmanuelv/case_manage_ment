...
<div class="d-flex align-items-center">
    <a href="section19-notice-report.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Section 19 of DRT Notice</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="card card-case">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs nav-bordered mb-3" id="caseTabs" role="tablist">
                                    ...
                                    <!--<li class="nav-item">-->
                                    <!--    <a href="#Freeze" data-bs-toggle="tab" class="nav-link" role="tab">Bank Freeze Details</a>-->
                                    <!--</li>-->
                                </ul>
