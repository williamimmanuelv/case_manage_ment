...
<div class="d-flex align-items-center">
  <a href="section41-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
...
<div class="card ">
  <div class="card-body">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="custom-table green-table case-table">
              <tr>
                <td>Case Type</td>
                <td class="empty-cell">Against Case</td>
                <td>SubCase Type</td>
                <td class="empty-cell">Sec 41 of Appeal to Consumer court</td>
              </tr>
              <tr>
                <td>Filing Date</td>
    ...
    <div class="case-wrapper-darkcyan mb-4">
      <div class="case-header">
        Appeal Case
      </div>
      ...
      <div class="card mb-0" style="border-radius: 8px;">
        <div class="card-body">
          <div class="table-responsive">
            <table class="custom-table darkcyan-table case-table">
              <thead>
                <tr>
                  <th>S.NO</th>
                  <th>Case Type</th>
              ...
              <tbody>
                <tr>
                  <td class="empty">1</td>
                  <td class="empty">Against Case</td>
                  <td class="empty">Sec 41 of Appeal to Consumer court</td>
                  <td class="empty">Section 35 of Consumer Act</td>
                </tr>
              </tbody>
            </table>
          </div>
    ...
    <div class="case-wrapper-blueviolet mb-4">
      <div class="case-header">
        Caveat Application
      </div>
      ...
      <div class="card mb-0" style="border-radius: 8px;">
        <div class="card-body">
          <div class="table-responsive">
            <table class="custom-table blueviolet-table case-table">
              <thead>
                <tr>
                  <th>S.No</th>
                  <th>Loan Number</th>
              ...
              <tbody>
                <tr>
                  <td class="empty">1</td>
                  <td class="empty">LN-100234</td>
                  <td class="empty">Against Case</td>
                  <td class="empty">Civil Case u/s O7 R1</td>
                  <td class="empty">CUST-001</td>
                  <td class="empty">Ramesh Kumar</td>
                  <td class="empty">Suresh Kumar</td>
                  <td class="empty">10-01-2026</td>
                  <td class="empty">09-01-2026</td>
                  <td class="empty">CAV-2025-001</td>
                </tr>
                <tr>
                  <td class="empty">2</td>
                  <td class="empty">LN-100234</td>
