...
<div class="d-flex align-items-center">
    <a href="summary-suit-notice-report.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Summary Suit Notice</h5>
            </div>
            <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-bordered mb-3" id="caseTabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="#Applicant" data-bs-toggle="tab" class="nav-link" role="tab">
                                        <span class="d-md-inline-block">Sender</span> </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="#schedule" data-bs-toggle="tab" class="nav-link" role="tab"> <span
                                            class="d-md-inline-block">Schedule</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#extra-coloumn" data-bs-toggle="tab" class="nav-link" role="tab"> <span
                                            class="d-md-inline-block">Extra Column</span>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select subcase-edit d-none" data-type="CivilCase">
                                    <option value="">Select</option>
                                    <!-- <option value="civil-suit">Summary Suit</option> -->
