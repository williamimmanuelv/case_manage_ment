...
<div class="d-flex align-items-center">
  <a href="arbitration-award-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="custom-table green-table case-table">
              <tr>
                <td>Case Type</td>
                <td class="empty-cell">EP Case </td>
                <td>Filing Date</td>
                <td class="empty-cell">14-02-2026</td>
              </tr>
              <tr>
                <td>Sub Case Type</td>
                <td class="empty-cell">Arbitration Award</td>
                <td>Filing Number</td>
              ...
              <tr>
                <td>Loan Number</td>
                <td class="empty-cell">LN 1234/56</td>
              ...
              <tr>
                ...
                <td>EP Stage</td>
                <td class="empty-cell">Attachment and sale of Movables</td>
            ...
            <table class="custom-table red-table case-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="empty">Payment Done</td>
                </tr>
              </tbody>
            </table>
          </div>
