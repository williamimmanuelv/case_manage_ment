...
<div class="d-flex align-items-center">
    <a href="arbitration-sec9-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Arbitration Section 9 Case Creation</h5>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            <label class="form-label">Sub Case Type <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" value="Section 9">
                                        </div>
                                    </div>
