...
<div class="d-flex align-items-center">
  <a href="section34-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
  ...
  <div class="col-xl-12">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title">Section34 Case Creation</h5>
      </div>
      <div class="card-body">
        ...
        <div class="tab-content">
              ...
              <div class="card-body">
                ...
                <div class="tab-content" id="caseTabsContent">
                  ...
                  <div class="tab-pane fade" id="Product" role="tabpanel">
                    <div class="table-responsive scrollBarThin" style="height: 300px;  border: 1px solid #8080803b;">
                  ...
                  <div class="tab-pane fade show active" id="home" role="tabpanel">
                    <div class="row g-4">
                      ...
                      <div class="col-md-6 col-lg-4">
                        <label class="form-label">Case Nature <span style="color:red;">*</span></label>
                        <select class="form-select" id="caseNature">
                          <option value="">Select Nature</option>
                          <option value="Fresh">Fresh</option>
                          <option value="Appeal">Appeal</option>
                          <option value="Connect">Connect Case</option>
                        </select>
                      </div>

                      <!-- CNR NO -->
                      <div class="col-md-6 col-lg-4" id="cnrDiv" style="display:none;">
                        <label class="form-label">CNR NO</label>
                        <input type="text" class="form-control" placeholder="Enter CNR No" />
                      </div>

                      <!-- Case NO -->
                      <div class="col-md-6 col-lg-4" id="caseNoDiv" style="display:none;">
          ...
          <div id="unameTab" class="tab-pane">
            <div class="form-group">
              ...
              <!-- Report List -->
              <div class="table-responsive scrollBarThin mt-3">
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    const caseNature = document.getElementById("caseNature");
    const cnrDiv = document.getElementById("cnrDiv");
    const caseNoDiv = document.getElementById("caseNoDiv");

    caseNature.addEventListener("change", function() {
      if (this.value === "Appeal" || this.value === "Connect") {
        cnrDiv.style.display = "block";
        caseNoDiv.style.display = "block";
      } else {
        cnrDiv.style.display = "none";
        caseNoDiv.style.display = "none";
      }
    });
  });
</script>
