    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active">
          Civil Case u/s O7 R1 Case Details
        </li>
      </ol>
    </nav>
  </div>
    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Civil Case u/s O7 R1 Case Details</h5>
          <div>
            <a href="civilcaser1-case-creation.php" class="btn btn-primary btn-sm">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td>
                        <a href="#" style=" color: green; background-color: transparent;" class="btn btn-success btn-sm" data-bs-toggle="offcanvas" data-bs-target="#createCivil">
                          <i class="ti ti-plus"></i>
                        </a>

                        <a href="#" class="btn btn-sm btn-primary me-2" style="color: #cda85d !important; background-color: transparent;" data-bs-toggle="offcanvas" data-bs-target="#editCivil">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Allo001</td>
                      <td>
                        <a href="civilcaser1-case-list.php" class="badge badge-outline-info me-2">
                          LNAB5A57
                        </a>
                      </td>
                      <td>CUST03300B</td>
                      ...
                      <td>Business Loan</td>
                      <td>
                        <!-- <a class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#contestModal">
                          <span class="ti ti-edit"> </span></a> -->

                        <a class="btn btn-sm btn-primary me-2" style="color: #cda85d !important; background-color: transparent;" data-bs-toggle="offcanvas" data-bs-target="#editCivil">
                          <i class="ti ti-edit"></i>
                        </a>
...
<div class="offcanvas custom-offcanvas offcanvas-end " tabindex="-1" id="createCivil" data-bs-backdrop="static"
...
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary">Update Case</button>
      </div>
    </div>
  </div>
</div>
...
<div class="offcanvas custom-offcanvas offcanvas-end " tabindex="-1" id="editCivil" data-bs-backdrop="static"
  data-bs-keyboard="false">
  <div class="offcanvas-header border-bottom">
...
<div class="modal fade" id="contestModal" tabindex="-1" aria-labelledby="contestModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header text-white">
        <h5 class="modal-title" id="contestModalLabel">Update Case Status</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form>
