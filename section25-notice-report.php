  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title">Section 25 Notice Report</h5>
        <div>
          <a href="section25-notice-creation.php" class="btn btn-primary btn-sm">
              ...
              <div class="col-md-12">
                <div class="mb-3">
                  ...
                  <select class="form-select" id="caseType_edit">
                    ...
                    <option value="ArbitrationCase">Crimininal Case</option>
              ...
              <div class="col-md-12">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select subcase-edit d-none" data-type="ArbitrationCase">
                    ...
                    <option value="Section17">Section 25</option>
