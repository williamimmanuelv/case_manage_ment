...
<div class="d-flex align-items-center">
    <a href="section25-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Section 25 Case Creation</h5>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            <label for="input-label" class="form-label">Case Type <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" value="Criminal Case">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            <label for="input-label" class="form-label">Sub Case Type <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" value="Section 25">
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="caseTabsContent">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <label for="example-select" class="form-label">Case Nature <span
                                                        style="color:red;">*</span></label>
                                                <input type="text" class="form-control" value="Fresh" />
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="vehicle" role="tabpanel">
                                        ...
                                        <div class="d-flex justify-content-end gap-1 mt-3">
                                            <button class="btn btn-secondary prev-tab">Previous</button>
                                            <button class="btn btn-primary next-tab">Save</button>
                                        </div>
                                    </div>
