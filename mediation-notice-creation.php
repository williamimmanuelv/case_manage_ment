...
<div class="d-flex align-items-center">
  <a href="mediation-notice.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
                ...
                <div class="tab-content" id="concTabsContent">
                  ...
                  <div class="tab-pane fade show active" id="notice" role="tabpanel">
                    ...
                    <div class="row g-4">
                      ...
                      <div class="col-md-4">
                        <label class="form-label">Conciliator Name</label>
                        <input type="text" class="form-control" placeholder="Conciliator Name">
                      </div>

                      <div class="col-md-4">
                        <label class="form-label">Conciliation Location</label>
                        <input type="text" class="form-control" placeholder="Conciliation Location">
                      </div>

                      <div class="col-md-4">
                        <label class="form-label">Conciliation Time</label>
                        <input type="time" class="form-control">
                      </div>
                      ...
                      <div class="col-md-4">
                        <label class="form-label">Customer RPAD Number</label>
                        <input type="text" class="form-control" placeholder="Customer RPAD No">
                      </div>

                      <div class="col-md-4">
                        <label class="form-label">Cheque Bounce Date</label>
                        <input type="date" class="form-control">
                      </div>
                      ...
                      <div class="col-md-4">
                        <label class="form-label">Cheque Bounce Reason</label>
                        <input type="text" class="form-control" placeholder="Bounce Reason">
                      </div>

                      <div class="col-md-4">
                        <label class="form-label">Settlement Letter Number</label>
                        <input type="text" class="form-control" placeholder="Settlement Letter No">
                      </div> -->
                  ...
                  <div class="tab-pane fade" id="Applicant" role="tabpanel">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="mb-3">
                          <label for="input-label" class="form-label">Addres 1</label>
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="mb-3">
                          <label for="input-label" class="form-label">Addres 2</label>
                          <input type="text" class="form-control" placeholder="Addres " />
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-lg-4">
                        <div class="mb-3">
                          <label for="input-label" class="form-label">Addres 3</label>
                          <input type="text" class="form-control" placeholder="Addres " />
                        </div>
                      </div>
                ...
                <table class="table table-nowrap datatable table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>Mediation Notice Name</th>
                      <th>Mediation Notice Vendor </th>
                      <th>Mediation Notice Date</th>
                      <th>Customer Name</th>
                      <th>Address 1</th>
                      <th>Address 2</th>
                      <th>Address 3</th>
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td>REF12234</td>
                      <td>Mediation Notice Name 1</td>
                      <td>Mediation Notice Vendor 1</td>
                      <td>25-11-2025</td>
                      <td>Rahul Kumar</td>
