...
<div class="card ">
  <div class="card-body">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="custom-table green-table case-table">
              <tr>
                <td>Case Type</td>
                <td class="empty-cell">Section 14</td>
                <td>Filing Date</td>
    ...
    <div class="case-wrapper-hotpink mb-4">
      <div class="case-header">
        Advocate Commission
      </div>
      ...
      <div class="card mb-0" style="border-radius: 8px;">
        <div class="card-body">
          <div class="table-responsive">
            <table class="custom-table hotpink-table case-table">
              <thead>
                <tr>
                  <th>S.NO</th>
                  <th>Advocate Commission Name</th>
                  <th>Advocate Commission Mobile No</th>
                  <th>Advocate Commission Address</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="empty">1</td>
                  <td class="empty">Adv. Rajesh Kumar</td>
                  <td class="empty">9876543210</td>
                  <td class="empty">Anna Nagar, Chennai</td>
                </tr>
              </tbody>
            </table>
          </div>
