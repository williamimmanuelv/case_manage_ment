...
<div class="d-flex align-items-center">
  <a href="writ-petition-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
          ...
          <div class="table-responsive">
            <table class="custom-table green-table case-table">
              <tr>
                ...
                <td>SubCase Type</td>
                <td class="empty-cell">Writ Petition u/s 226</td>
              </tr>
              <tr>
                <td>Filing Date</td>
