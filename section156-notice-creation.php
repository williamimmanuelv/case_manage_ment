...
<div class="d-flex align-items-center">
    <a href="section156-notice-report.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Cr-Section 156(3) Order Notice</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="card card-case">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-bordered mb-3" id="caseTabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="#loan" data-bs-toggle="tab" class="nav-link" role="tab">FIR Details</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-content" id="caseTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel">
                                    ...
                                    <div class="row g-4 mt-1">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <label for="txt_collec_mang_number" class="form-label">Collection Manager
                                                Number</label>
                                            <input type="text" class="form-control"
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <label for="txt_collec_mang_mail" class="form-label">Collection Manager Mail
                                                id</label>
                                            <input type="text" class="form-control"
                                ...
                                <div class="tab-pane fade" id="loan" role="tabpanel">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">Offense Under</label>
                                            <input type="text" class="form-control" placeholder="Offense Under">
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label">No of accused</label>
                                            <input type="text" class="form-control" placeholder="No of accused">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">FIR Number / CSR Number</label>
                                            <input type="text" class="form-control" placeholder="FIR Number/CSR Number">
                                        </div>

                                        <div class="col-md-4">
                                            <label class="form-label">Brief of the Case</label>
                                            <textarea name="" class="form-control" placeholder="Brief of the case"
                                                id=""></textarea>
                                        </div>
