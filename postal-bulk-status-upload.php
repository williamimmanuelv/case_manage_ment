    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Postal Bulk Status Upload </h5>
                ...
                <div class="menu">
                    ...
                    <a href="#" class="link" type="button"
                        ...
                        data-bs-target="#postalStatusAccordion"
                        aria-expanded="false"
                        aria-controls="postalStatusAccordion">
            ...
            <div class="collapse" id="postalStatusAccordion">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header text-white">
                <h5 class="modal-title" id="editModalLabel">Download Postal</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form>
