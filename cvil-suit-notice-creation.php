...
<div class="d-flex align-items-center">
    <a href="cvil-suit-notice-report.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Civil Suit Notice</h5>
            </div>
            <div class="card-body">
                            ...
                            <div class="tab-content" id="caseTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel">
                                    ...
                                    <div class="d-flex justify-content-end gap-1 mt-3">
                                        <button class="btn btn-secondary prev-tab btn-sm">Previous</button>
                                        <button class="btn btn-primary next-tab btn-sm">Next</button>
                                    </div>
                                </div>
