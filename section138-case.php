    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active">
          Sec 138 of NI Act Case Details
        </li>
      </ol>
    </nav>
  </div>
    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Sec 138 of NI Act Case Details</h5>
        </div>
        <div class="card-body">
          ...
          <ul class="nav nav-tabs nav-justified nav-bordered nav-bordered-success mb-3">
            ...
            <li class="nav-item">
              <a data-bs-toggle="tab" href="#pending" aria-expanded="false" class="nav-link active">
                <span class="d-md-inline-block">Pending (2)</span>
              </a>
            </li>
            <li class="nav-item">
              <a data-bs-toggle="tab" href="#old" aria-expanded="false" class="nav-link ">
                <span class="d-md-inline-block">Live (3)</span>
              </a>
            </li>
            <li class="nav-item">
              <a data-bs-toggle="tab" href="#Contest" aria-expanded="false" class="nav-link ">
                <span class="d-md-inline-block">Contest (3)</span>
              </a>
            </li>
            <li class="nav-item">
              <a data-bs-toggle="tab" href="#overall" aria-expanded="false" class="nav-link ">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Allo001</td>
                      <td>
                        <a href="section138-case-list.php" class="badge badge-outline-info me-2">
                          LNAB5A57
                        </a>
                      </td>
                      <td>CUST03300B</td>
...
<div class="offcanvas custom-offcanvas offcanvas-end " tabindex="-1" id="addProduct" data-bs-backdrop="static"
  ...
  <div class="offcanvas-header border-bottom">
    <h5 class="fw-semibold">Add Case Status</h5>
    <button type="button"
