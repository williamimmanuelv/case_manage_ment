    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Arbitration Award Case Details</h5>
        </div>
        <div class="card-body">
          ...
          <ul class="nav nav-tabs nav-justified nav-bordered nav-bordered-success mb-3" id="caseTabs" role="tablist">
            ...
            <!-- <li class="nav-item" role="tab">
              <a class="nav-link d-flex align-items-center"
                href="arbitration-award-case-creation.php">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td>
                        <a href="#" class="btn btn-sm btn-success btn-sm" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add">
                          <i class="ti ti-plus"></i>
                        </a>
                        <a href="#" class="btn btn-sm btn-edit " data-bs-toggle="offcanvas" data-bs-target="#offcanvas_edit">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Arbitration Award</td>
                      <td> CUS 1001</td>
                      <td><a href="arbitration-award-case-list.php" class="badge badge-outline-info">
                          LN 1234/56
                        </a> </td>
                      <td> Car Loan</td>
                      <td> Ram</td>
