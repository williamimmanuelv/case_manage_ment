    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active">
          Cr- Bail/Anticipartory bail Case Details
        </li>
      </ol>
    </nav>
  </div>
    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Cr- Bail/Anticipartory bail Case Details</h5>
          <div>
            <a href="anticipartory-case-creation.php" class="btn btn-primary btn-sm">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>0 days</td>
                      <td>By Case</td>
                      <td>Cr- Bail/Anticipartory bail</td>
                      <td>Allo001</td>
                      <td>LNAB5A57</td>
                      <td>Sandeep Rao</td>
                      <td>Business Loan</td>
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Allo001</td>
                      <td>
                        <a href="anticipartory-case-list.php" class="badge badge-outline-info me-2">
                          LNAB5A57
                        </a>
                      </td>
                      <td>CUST03300B</td>
