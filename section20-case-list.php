...
<div class="d-flex align-items-center">
  <a href="section20-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
          ...
          <div class="table-responsive">
            <table class="custom-table green-table case-table">
              <tr>
                ...
                <td>SubCase Type</td>
                <td class="empty-cell">Sec 20 of DRT ( Appeal)</td>
              </tr>
              <tr>
                <td>Filing Date</td>
            ...
            <table class="custom-table darkcyan-table case-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="empty">Sec 20 of DRT ( Appeal)</td>
                  <td class="empty">Sec 17 of DRT (SA)</td>
                </tr>
              </tbody>
            </table>
          </div>
