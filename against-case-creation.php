...
<div class="d-flex align-items-center">
    <a href="against-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <label for="example-select" class="form-label">Case Nature <span
                                                        style="color:red;">*</span></label>
                                                <input type="text" class="form-control" value="Against Case" />
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <label for="cnr" class="form-label">SR NO</label>
                                                <input type="text" class="form-control" id="cnr" placeholder="SR" />
                                            </div>
