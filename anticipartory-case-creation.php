...
<div class="d-flex align-items-center">
    <a href="anticipartory-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Cr- Bail/Anticipartory bail Case Creation</h5>
            </div>
            <div class="card-body">
                        ...
                        <div class="card card-case">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs nav-bordered mb-3" id="caseTabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a href="#loan" data-bs-toggle="tab" class="nav-link" role="tab">FIR </a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="caseTabsContent">
                                    ...
                                    <div class="tab-pane fade" id="loan" role="tabpanel">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-label">Offence Under</label>
                                                <input type="text" class="form-control" placeholder="Offence Under">
                                            </div>
