    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Lok Adalt Case Details</h5>
        </div>
        <div class="card-body">
          ...
          <ul class="nav nav-tabs nav-justified nav-bordered nav-bordered-success mb-3" id="caseTabs" role="tablist">
            ...
            <!-- <li class="nav-item" role="tab">
              <a class="nav-link d-flex align-items-center"
                href="lok-adalt-case-creation.php">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td> CUS 1001</td>
                      <td>
                        <a href="lok-adalt-case-list.php" class="badge badge-outline-info me-2">
                          LN1234/7
                        </a>
                      </td>
                      <td> Car Loan</td>
