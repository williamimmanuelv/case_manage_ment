...
<div class="d-flex align-items-center">
    <a href="arbitration-award-notice-report.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
                                            ...
                                            <table id="tbl_postal_create" class="table dataTable table-nowrap table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>3</td>
                                                        <td>₹ 4,20,000</td>
                                                        <td><button class="btn btn-sm btn-outline-danger"><i class="ti ti-trash"></i></button></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
