    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Case Close Report </h5>
                <div class="menu">
            ...
            <div class="collapse" id="postalBulkAccordion">
                ...
                <div class="container" style="padding: 20px 20px 0px 20px;">
                    ...
                    <div class="row align-items-center ">
                        ...
                        <!-- Allocation No -->
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-allocation">
                            <div class="mb-2">
                        ...
                        <!-- Loan No -->
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-loan">
                            <div class="mb-2">
                                <label class="form-label">Loan No</label>
                                <select class="form-select">
                                    <option value="">Select Loan No</option>
                                    <option>LN1234</option>
                                    <option>LN1235</option>
                                    <option>LN1236</option>
                                    <option>LN1237</option>
                                    <option>LN1238</option>
                                </select>
                            </div>
                        </div>

                        <!-- Product Name -->
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-product">
                            <div class="mb-2">
                        ...
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-casetype">
                            <label for="cnr" class="form-label">Case Type</label>
                            <select class="form-select" id="caseType_create">
                                <option value="">Select</option>
                                <option value="Case">Litigation By Case</option>
                        ...
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-subcase">
                            <label class="form-label">Sub Case Type</label>
                        ...
                        <!-- Court name -->
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-court">
                            <div class="mb-2">
                        ...
                        <!-- Start date -->
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-start">
                            <div class="mb-2">
                        ...
                        <!-- End date -->
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-end">
                            <div class="mb-2">
                        ...
                        <!-- Case no -->
                        <div class="col-md-6 col-lg-4 mt-2 filter-field" id="filter-caseno">
                            <div class="mb-2">
