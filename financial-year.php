  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title">Financial Year Report</h5>
        <div>
...
<div class="offcanvas custom-offcanvas offcanvas-end " tabindex="-1" id="editProduct" data-bs-backdrop="static"
  ...
  <div class="offcanvas-header border-bottom">
    <h5 class="fw-semibold">Edit Financial Year</h5>
    <button type="button"
      ...
      <div class="row">
        <div col="col-12">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="txt_title" maxlength="9" placeholder="2025-2026"
              autocomplete="off">
          </div>
        </div>
        <div col="col-12">
