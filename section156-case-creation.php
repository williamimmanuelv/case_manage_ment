...
<div class="d-flex align-items-center">
    <a href="section156-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0"
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Cr-Section 156(3) Order Case Creation</h5>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            <label class="form-label">Sub Case Type <span
                                                    style="color:red;">*</span></label>
                                            <input type="text" class="form-control" value="Section 156">
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="loan" role="tabpanel">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="FIR Number/CSR Number">
                                            </div>
