    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active">
          Writ Petition-Respondent Case Details
        </li>
      </ol>
    </nav>
  </div>
    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Writ Petition-Respondent Case Details</h5>

          <div>
            <a class="btn btn-primary btn-sm"
              href="petition-respondent-case-creation.php">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>AID1001</td>
                      <td>Against Cases</td>
                      <td>Writ Petition-Respondent</td>
                      <td> CUS 1001</td>
                      <td> 1234/56</td>
                      <td> Car Loan</td>
                      <td> Ram</td>
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Writ Petition-Respondent</td>
                      <td> CUS 1001</td>
                      <td><a href="petition-respondent-case-list.php" class="badge badge-outline-info me-2">
                          LN 1234/56
                        </a> </td>
                      <td> Car Loan</td>
                      <td> Ram</td>
