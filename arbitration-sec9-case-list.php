...
<div class="d-flex align-items-center">
  <a href="arbitration-sec9-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
          ...
          <div class="table-responsive">
            <table class="custom-table green-table case-table">
              <tr>
                ...
                <td>SubCase Type</td>
                <td class="empty-cell">Sec 9 of Arbitration Act</td>
              </tr>
              <tr>
                <td>Filing Date</td>
              ...
              <tr>
                <td>Court Name</td>
                <td colspan="3" class="empty-cell">Chief Metropolitan Magistrate Court, Egmore, Ch-8</td>
              </tr>
            </table>
          </div>
        </div>
