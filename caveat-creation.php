...
<div class="d-flex align-items-center">
  <a href="caveat-report.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="card-title">Caveat Creation</h5>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive scrollBarThin mt-3" style="height: 300px; border: 1px solid #8080803b;">
        ...
        <div class="text-end mt-3">
          <a href="#" class="btn btn-sm text-dark btn-outline-danger cancelBtn">Cancel</a>
          <!-- <a href="#" class="btn btn-sm btn-cancle">Cancel</a> -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-sm cancelBtn" data-bs-dismiss="modal">Cancel</button>
