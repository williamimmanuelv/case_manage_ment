    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Sec 17 of DRT Case Details</h5>
          <!--<div>-->
          <!--  <a href="section17-case-creation.php" class="btn btn-primary btn-sm">-->
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Allo001</td>
                      <td>
                        <a href="section17-case-list.php" class="btn btn-sm btn-primary me-2">
                          LNAB5A57
                        </a>
                      </td>
                      <td>CUST03300B</td>
