...
<div class="d-flex align-items-center">
  <a href="lok-adalat.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header d-flex align-items-center ">
        <h5 class="card-title">Lok Adalat Notice</h5>
                ...
                <table class="table table-nowrap datatable table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>Lok Adalat Notice Name</th>
                      <th>Lok Adalat Notice Vendor </th>
                      <th>Lok Adalat Notice Date</th>
                      <th>Customer Name</th>
                      <th>Address 1</th>
                      <th>Address 2</th>
                      <th>Address 3</th>
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td>REF12234</td>
                      <td>Lok Adalat Notice Name 1</td>
                      <td>Lok Adalat Notice Vendor 1</td>
                      <td>25-11-2025</td>
                      <td>Rahul Kumar</td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header text-white">
        <h5 class="modal-title" id="creationModalLabel">Lok Adalat Notice Upload</h5>
      ...
      <div class="modal-body">
        <form>
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label">Lok Adalat Notice Name</label>
                <input type="text" class="form-control" placeholder="Lok Adalat Notice Name">
              </div>
            </div>

            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label">Lok Adalat Notice Vendor</label>
                <input type="text" class="form-control" placeholder="Lok Adalat Notice Vendor">
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
                <label class="form-label">Lok Adalat Notice Date</label>
                <input type="date" class="form-control">
              </div>
            </div>
            <div class="col-md-6">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header text-white">
        <h5 class="modal-title" id="editModalLabel">Lok Adalat Notice Download</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form>
