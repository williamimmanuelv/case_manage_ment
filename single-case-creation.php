                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            <label for="input-label" class="form-label">Sub Case Type <span
                                                    style="color:red;">*</span></label>
                                            <select class="form-select" id="sub-case" value="Civil-Case">
                                                <option value="">Select</option>
                                            ...
                                            <select class="form-select" id="sub-case" value="Criminal-Case">
                                                <option value="">Select</option>
                                            ...
                                            <select class="form-select" id="sub-case" value="DRT-Case">
                                                <option value="">Select</option>
                                                <option value="Section 18">Section 18</option>
                                                <option value="Section 19">Section 19</option>
                                                <option value="Writ">Writ</option>
                                            </select>

                                            <select class="form-select" id="sub-case" value="NACLT-Case">
                                                <option value="">Select</option>
                                            </select>

                                            <select class="form-select" id="sub-case" value="Cousumer-Case">
                                                <option value="">Select</option>
                                                <option value="District Case">District Case</option>
                                                <option value="State Case">State Case</option>
                                                <option value="EP">EP</option>
                                                <option value="National Case">National Case</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-content" id="caseTabsContent">
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox section-138 d-none">
                                                <label for="input-label" class="form-label">Cheque Presented Bank and
                                                    Address</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Bank and Address" />
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox section-138 d-none">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Legal notice status " />
                                            </div>

                                            <div class="col-md-6 col-lg-4 casebox section-138 d-none">
                                                <label for="input-label" class="form-label">Legal Notice Return
                                                    Date</label>
                                                <input type="date" class="form-control" />
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox section-138 d-none">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Notice return status" />
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox section-25 d-none">
                                                <label for="input-label" class="form-label">Mandate Presented Bank and
                                                    Address</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Mandate presented bank and address" />
                                            </div>
                                            ...
                                            <div class="col-md-6 col-lg-4 casebox return-of-property d-none">
                                                <label for="input-label" class="form-label">Offenses Under
                                                    Section</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Offenses under section" />
                                            </div>
