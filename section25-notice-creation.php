...
<div class="d-flex align-items-center">
  <a href="section25-notice-report.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
  ...
  <div class="col-xl-12">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between ">
        <h5 class="card-title">Sec 25 of PASAct Notice</h5>
                ...
                <ul class="nav nav-tabs nav-bordered mb-3" id="caseTabs" role="tablist">
                  <li class="nav-item">
                    <a href="#home" data-bs-toggle="tab" class="nav-link active" role="tab">
                      <span class="d-md-inline-block">Notice Details</span>
                    </a>
                  </li>
                  <!-- <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="#Applicant" data-bs-toggle="tab" class="nav-link" role="tab">
                      <span class="d-md-inline-block">Sender Details</span>
                    </a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="tab-content" id="caseTabsContent">
                  ...
                  <div class="tab-pane fade show active" id="home" role="tabpanel">
                    <div class="row g-4">
                      ...
                      <div class="col-md-6 col-lg-4 casebox">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>Mandate Present Date</th>
                      <th>Presented Bank & Address</th>
                      <th>Return Reason</th>
                      <th>Legal Notice Date</th>
                      <th>Legal Notice Status</th>
                      <th>Legal Notice Return Date</th>
                      ...
                      <th>Collection Manager Mobile</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Allot002</td>
                      <td>By Case</td>
                      <td>Sec 138 NI Act</td>
                      <td>Negotiable Instruments Act</td>
                      <td>Section 138</td>
                      <td>South Zone</td>
                      <td>Tamil Nadu</td>
                      <td>Chennai</td>
                      <td>Velachery Branch</td>
                      <td>CUST10245</td>
                      <td>Fresh</td>
                      <td>LN789001</td>
                      <td>Car Loan</td>
                      ...
                      <td>₹85,000</td>
                      <td>10-01-2026</td>
                      <td>ICICI Bank, T Nagar Chennai</td>
                      ...
                      <td>Ramesh Kumar</td>
                      <td>9123456780</td>
                      <td>12/7 Anna Street, Chennai</td>
                      <td>Maruti</td>
                      <td>Swift</td>
                      <td>MA3EWB22S12345678</td>
                      <td>K12MN345678</td>
                      <td>TN09AB1234</td>
                      <td>Data A</td>
                      <td>Data B</td>
