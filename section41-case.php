    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active">
          Sec 41 of Appeal to Consumer court Case Details
        </li>
      </ol>
    </nav>
  </div>
    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Sec 41 of Appeal to Consumer court Case Details</h5>
          <div>
            <a href="section41-case-creation.php" class="btn btn-primary btn-sm">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>0 days</td>
                      <td>Against Case</td>
                      <td>Sec 41 of Appeal to Consumer court</td>
                      <td>Allo001</td>
                      <td>LNAB5A57</td>
                      <td>Sandeep Rao</td>
                      <td>Business Loan</td>
                      ...
                      <td></td>
                      <td>
                        <a href="#" style=" color: green; background-color: transparent;" class="btn btn-success btn-sm" data-bs-toggle="offcanvas" data-bs-target="#createSection">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Allo001</td>
                      <td>
                        <a href="section41-case-list.php" class="badge badge-outline-info me-2">
                          LNAB5A57
                        </a>
                      </td>
                      <td>CUST03300B</td>
