...
<div class="d-flex align-items-center">
    <a href="petition-respondent-case.php" class="mb-3 text-primary" style="font-weight: 600;"> <i
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">Writ Petition-Respondent Case Creation</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="mb-3 d-flex align-items-center justify-content-center">
                                ...
                                <button class="btn btn-sm btn-primary btn-sm ms-3">
                                    <i class="ti ti-download"></i>
                                </button>
                            </div>
                        </div>
