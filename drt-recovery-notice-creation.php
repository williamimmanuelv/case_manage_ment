...
<div class="d-flex align-items-center">
    <a href="drt-recovery-notice-report.php" class="mb-3 text-primary" style="font-weight: 600;"> <i class="ti ti-arrow-left mt-0" style="font-size: 16px;font-weight: 600;"></i> Go Back </a>
</div>
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="card-title">DRT Recovery Notice Creation</h5>
                    ...
                    <div id="otpTab" class="tab-pane active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="Sub Case Type">
                                        </div>
                                    </div>
                        ...
                        <div class="card card-case">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs nav-justified nav-bordered nav-bordered-danger mb-3" id="caseTabs" role="tablist">
                                    <li class="nav-item">
                                        <a href="#home" data-bs-toggle="tab" class="nav-link active" role="tab">Notice </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="#lok" data-bs-toggle="tab" class="nav-link" role="tab">Lok Adalat</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="caseTabsContent">
                                    ...
                                    <div class="tab-pane fade" id="Product" role="tabpanel">
                                        <div class="table-responsive" style="height: 300px; border: 1px solid #e1e8f0;">
                                            <table id="tbl_postal_create" class="table dataTable table-nowrap table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>3</td>
                                                        <td>₹ 4,20,000</td>
                                                        <td><button class="btn btn-sm btn-cancel btn-outline-danger"><i class="ti ti-trash"></i></button></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <label for="input-label" class="form-label">EP Stage</label>
                                                <select class="form-select" id="example-select">
                                                    <option>select</option>
                                                    <option value="Movables">Attachment and sale of Movables</option>
                                                    <option value="Immovables">Attachment and Sale of Immovables</option>
                                                    <option value="Arrest">Arrest and Detention Of JD</option>
                                                    <option value="Garnishee">Garnishee Proceedings</option>
                                                    <option value="Possession">Delivery of Possession</option>
                                                    <option value="Receiver">Appointment of Receiver</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="lok" role="tabpanel">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" placeholder="Mediator Venue">
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="Applicant" role="tabpanel">
                                        <div class="table-responsive" style="height: 300px; border: 1px solid #e1e8f0;">
                                            <table class="table dataTable table-nowrap table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th>S.No</th>
                                                        <th>Sender Type</th>
                                        ...
                                        <div class="row g-4 mt-2">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <label for="input-label" class="form-label">Sender Name <span style="color:red;">*</span></label>
                                    ...
                                    <div class="tab-pane fade" id="schedule" role="tabpanel">
                                        ...
                                        <div class="table-responsive" style="height: 300px; border: 1px solid #30477b;">
                                            <table class="table dataTable table-nowrap table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th>S.No</th>
