    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active">
          Section 35 of Consumer Act Case Details
        </li>
      </ol>
    </nav>
  </div>
    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Section 35 of Consumer Act Case Details</h5>
          <div>
            <a class="btn btn-primary btn-sm"
              href="section35-case-creation.php">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Sec 35 of Consumer Act</td>
                      <td> CUS 1001</td>
                      <td><a href="section35-case-list.php" class="badge badge-outline-info me-2">
                          LN 1234/56
                        </a> </td>
                      <td> Car Loan</td>
                      <td> Ram</td>
