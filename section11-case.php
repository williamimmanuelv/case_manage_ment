    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active">
          Section 11 of Arbitration Act Case Details
        </li>
      </ol>
    </nav>
  </div>
    ...
    <div class="col-xl-12">
      <div class="">
        <div class="card-header d-flex align-items-center justify-content-between">
          <h5 class="card-title">Section 11 of Arbitration Act Case Details</h5>
          <div>
            <a href="section11-case-creation.php" class="btn btn-primary btn-sm">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>0 days</td>
                      <td>Against Case</td>
                      <td>Sec 11 of Arbitration Act</td>
                      <td>Allo001</td>
                      <td>LNAB5A57</td>
                      <td>Sandeep Rao</td>
                      <td>Business Loan</td>
                      ...
                      <td></td>
                      <td>
                        <a href="#" class="btn btn-success btn-sm" style=" color: green; background-color: transparent;" data-bs-toggle="offcanvas" data-bs-target="#createSection">
                ...
                <table class="table table-nowrap datatable table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Allo001</td>
                      <td>
                        <a href="section11-case-list.php" class="badge badge-outline-info me-2">
                          LNAB5A57
                        </a>
                      </td>
                      <td>CUST03300B</td>
